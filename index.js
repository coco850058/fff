...
const PORT = process.env.SERVER_PORT || process.env.PORT || 11211;        // http服务订阅端口
const UUID = process.env.UUID || '9078ba9f-23c0-4726-a59e-7e2a4f5eedd0'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
